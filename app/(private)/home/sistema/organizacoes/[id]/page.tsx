    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="md:hidden">
        <Accordion type="single" collapsible className="w-full">
                      ...
                      {organization.admin.map((admin) => (
                        ...
                        >
                          <div className="flex-1 min-w-0">
                            <p className="font-medium text-sm truncate">{admin.name || "Sem nome"}</p>
          ...
          <AccordionItem value="campeonatos">
            <AccordionTrigger className="text-base font-semibold">
              Campeonatos
            </AccordionTrigger>
            <AccordionContent>
              <div className="pt-2">
                <Card className="p-4">
                  ...
                  {organization.organizedChampionships.length === 0 ? (
                    <p className="text-sm text-muted-foreground">Nenhum campeonato organizado.</p>
                  ) : (
                    <div className="space-y-2">
                        ...
                        >
                          <div className="flex-1">
                            ...
                            {championship.location && (
                              <p className="text-xs text-muted-foreground">{championship.location}</p>
                            )}
                          </div>
                          <Button asChild variant="outline" size="sm" className="w-full">
          ...
          <AccordionItem value="dados">
            ...
            <AccordionContent>
              <div className="pt-2">
                <Card className="p-4">
                  <h3 className="text-base font-semibold mb-3">Informações da Organização</h3>
                  <div className="space-y-3">
                    <div>
                      <p className="text-xs text-muted-foreground">Nome</p>
                      <p className="font-medium text-sm break-words">{organization.name}</p>
                    </div>
                    <div>
                    ...
                    {organization.stripeAccountId && (
                      <div>
                        <p className="text-xs text-muted-foreground">Stripe Account ID</p>
                        <p className="font-mono text-xs break-all">{organization.stripeAccountId}</p>
                      </div>
                    )}
                  </div>
                </Card>
