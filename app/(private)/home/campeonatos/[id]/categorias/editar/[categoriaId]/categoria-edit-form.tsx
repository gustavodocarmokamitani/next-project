...
import { updateCampeonatoCategoria } from "../../actions"
...
type CampeonatoCategoriaEditFormProps = {
  campeonatoId: string
  categoriaId: string
...
export function CampeonatoCategoriaEditForm({
  campeonatoId,
  categoriaId,
  categoria,
  categoriasGlobais,
}: CampeonatoCategoriaEditFormProps) {
  ...
  return (
    <form
      action={async (formData) => {
        ...
        await updateCampeonatoCategoria(campeonatoId, categoriaId, formData)
    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex items-center space-x-2">
          <Checkbox
            id="allowUpgrade"
            name="allowUpgrade"
            defaultChecked={categoria.allowUpgrade}
          />
          <Label
      ...
      <div className="flex gap-4 pt-4">
        ...
        <Button
          ...
          variant="outline"
          onClick={() =>
            router.push(`/home/campeonatos/${campeonatoId}/categorias`)
          }
